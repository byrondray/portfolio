...
export const EducationTab = () => {
    return (
        ...
        >
            <Card className='bg-white/80 dark:bg-black/60 backdrop-blur-sm border-gray-200 dark:border-gray-600 p-8'>
                <CardContent className='p-0'>
                    <div className='space-y-8'>
                        ...
                        >
                            ...
                            <p className='text-gray-500 dark:text-gray-400 mt-1'>2023 - 2025</p>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className='space-y-4'
                        >
                            <h3 className='text-xl font-semibold text-gray-900 dark:text-white'>Core Competencies Developed</h3>
