  ...
  return (
    <>
      <motion.div
        ...
        className="absolute left-0 top-20 m-auto h-14 w-px rounded-full z-10 transition-all duration-300 bg-gradient-to-t from-indigo-400 via-purple-400 to-transparent dark:from-indigo-500 dark:via-purple-500 dark:to-transparent"
      />
      <AnimatePresence>
