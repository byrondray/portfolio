  ...
  return (
    <>
          ...
          {processSteps.map((step, index) => (
            ...
            >
              <article className='relative'>
                ...
                <div className='bg-white/60 dark:bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-300 relative z-10'>
      ...
      <section className='mb-16'>
        <ScrollAnimation direction='up' delay={0.1} distance={20}>
          <h2 className='text-3xl font-bold text-gray-900 dark:text-white mb-12 text-center'>
            Core Principles
          </h2>
        </ScrollAnimation>
      ...
      <ScrollAnimation direction='up' delay={0.2} distance={20}>
        <section className='text-center'>
          <div className='bg-gradient-to-r from-indigo-500/10 to-purple-500/10 rounded-2xl p-8 border border-gray-200 dark:border-gray-700'>
